...
import { n as le, O as Ae, p as V, b as ee, v as fe, __tla as __tla_0 } from "./vaultService-CWBQnK3K.js";
import { B as xe, S as ce, a as Se, b as $, c as Ee, d as Te, M as ve, s as Ie, F as Ue, e as ue, f as Pe, g as Oe } from "./wa-sqlite-l0JLtCOf.js";
import { l as pe, d as Le, e as De, __tla as __tla_1 } from "./index-KodO2VD8.js";
import { a as Re } from "./qr-utils-DSii33i3.js";
import { _ as be, __tla as __tla_2 } from "./pdf-utils-r4RjNe6V.js";
import { a as de } from "./argon2-browser-qelKfid9.js";
import { l as _e, __tla as __tla_3 } from "./resourceRegistry-BcZxmsTZ.js";
...
`)[0].toLowerCase() : "";
    ...
    class ke extends xe {
        ...
        xOpen(r, e, t, o) {
            ...
            return this.mapIdToFile.set(e, i), o.setInt32(0, t, !0), $;
        }
        xClose(r) {
            const e = this.mapIdToFile.get(r);
            return e && (this.mapIdToFile.delete(r), e.flags & Ee && this.mapNameToFile.delete(e.name)), $;
        }
        xRead(r, e, t) {
            const o = this.mapIdToFile.get(r), i = Math.min(t, o.size), u = Math.min(t + e.byteLength, o.size) - i;
            return u && e.set(new Uint8Array(o.data, i, u)), u < e.byteLength ? (e.fill(0, u), Te) : $;
        }
        xWrite(r, e, t) {
            ...
            return new Uint8Array(o.data, t, e.byteLength).set(e), o.size = Math.max(o.size, t + e.byteLength), $;
        }
        xTruncate(r, e) {
            const t = this.mapIdToFile.get(r);
            return t.size = Math.min(t.size, e), $;
        }
        xFileSize(r, e) {
            const t = this.mapIdToFile.get(r);
            return e.setBigInt64(0, BigInt(t.size), !0), $;
        }
        xDelete(r, e) {
            return this.mapNameToFile.delete(r), $;
        }
        xAccess(r, e, t) {
            const o = this.mapNameToFile.get(r);
            return t.setInt32(0, o ? 1 : 0, !0), $;
        }
    }
    class Be extends ke {
        name = "memory-async";
    ...
    const Ve = {
        ...
        async parse (n) {
            ...
            try {
                ...
                else throw new U("无法识别传入的 PhoneFactor 数据格式", "INVALID_PHONEFACTOR_INPUT");
                const i = await ve({
                ...
                if (await p.exec(m, "SELECT name FROM sqlite_master WHERE type='table' AND name='accounts'", ()=>{
                    w = !0;
                }), !w) throw await p.close(m), new U("不是有效的 Microsoft Authenticator 数据文件", "INVALID_PHONEFACTOR_FILE");
                ...
                if (s && s.stmt) {
                    ...
                    try {
                        for(; await p.step(a) === Oe;){
                            const l = p.row(a), c = l[0], h = l[1], d = l[2], b = l[4];
                            if (!c && !h) continue;
                            let _ = (d || "").toString().trim();
                            if (!_) continue;
                            let S = "SHA1", v = 6;
                            try {
                                if (b !== 0) if (b === 1) _ = this.base64ToBase32(_), v = 8;
                                else if (b === 2) _ = _.toUpperCase(), S = "SHA256";
                                else continue;
                            } catch  {
                                continue;
                            }
                            const I = _.replace(/\s+/g, "").replace(/=+$/, "");
                            x.test(I) && y.push({
                                service: c || "Microsoft",
                                account: h || "Unknown",
                                secret: _,
                ...
                if (p.str_finish(f), await p.close(m), o.mapNameToFile.clear(), y.length === 0) throw new U("未能提取到有效的 TOTP 记录", "NO_DATA");
                return y;
            } catch (i) {
                throw pe.error("[PhoneFactor] parse failed:", i), i instanceof U ? i : new U(`PhoneFactor 解析失败: ${i.message}`, "PF_ERROR", i);
            }
        }
    }, He = {
        async parseImage (n) {
            return new Promise((r, e)=>{
                ...
                t.onload = ()=>{
                    ...
                    if (!g) return e(new U("未能识别出二维码，请确认为完整清晰的截图。", "QR_RECOGNITION_FAILED"));
                    const A = g.data;
                    if (!A.startsWith("otpauth-migration://offline?data=")) return e(new U("不是有效的 Google Authenticator 迁移二维码", "INVALID_GOOGLE_AUTH_QR"));
                    try {
                        ...
                        e(new U("解析 Google Authenticator 数据失败", "GOOGLE_AUTH_DECODE_FAILED", m));
                    }
                }, t.onerror = ()=>{
                    URL.revokeObjectURL(o), e(new U("图片读取失败，文件可能已损坏", "IMAGE_LOAD_FAILED"));
                }, t.src = o;
            });
        },
        decodePayload (n) {
                ...
                if (i === 1 && p === 2) {
                    ...
                    for(; e < g;){
                        ...
                        if (a === 1 && l === 2) {
                            ...
                            let b = 0, _ = 0, S = "";
                            for(let v = 0; v < h.length; v++)for(_ = _ << 8 | h[v], b += 8; b >= 5;)S += d[_ >>> b - 5 & 31], b -= 5;
                            b > 0 && (S += d[_ << 5 - b & 31]), A = S, e += c;
                        } else if (a === 2 && l === 2) {
                            const c = t();
        ...
        async exportToGoogleAuth (n) {
            if (!n || n.length === 0) throw new U("没有账户可以迁移", "EMPTY_VAULT");
            const r = Ae.google_auth || [
                "totp",
                "hotp"
            ], e = n.filter((w)=>r.includes((w.type || "totp").toLowerCase()));
            if (e.length === 0) throw new U("所选账号的类型 Google Authenticator 均不支持", "EMPTY_VAULT");
            const t = 10, o = [];
            for(let w = 0; w < e.length; w += t)o.push(e.slice(w, w + t));
            const i = Math.floor(Math.random() * 2147483647), p = await be(()=>import("./qr-utils-DSii33i3.js").then((w)=>w.b), __vite__mapDeps([0,1,2,3])), u = [];
            function g(w, y) {
            ...
            for(let w = 0; w < o.length; w++){
                ...
                for (const a of y){
                    ...
                    for(let D = 0; D < h.length; D++){
                        const P = c.indexOf(h[D]);
                        P !== -1 && (_ = _ << 5 | P, b += 5, b >= 8 && (d.push(_ >>> b - 8 & 255), b -= 8));
                    }
            ...
            for(let f = 1; f < r.length; f++){
                ...
                if (e.forEach((l, c)=>{
                    ...
                    if (c) if (c.toLowerCase().startsWith("otpauth://") || c.toLowerCase().startsWith("steam://")) {
                        const h = V(c);
                        if (h) {
                            const d = e.find((_)=>w.includes(_)), b = e.find((_)=>y.includes(_));
                            h.service = a[d] || h.service, h.account = a[b] || h.account, t.push(h);
                        }
                    } else {
                        const h = x(c);
                        if (/^[A-Z2-7]+=*$/.test(h)) {
                            let b = e.find((L)=>w.includes(L)), _ = e.find((L)=>y.includes(L));
                            e.includes("issuer") && e.includes("name") && (b = "issuer", _ = "name");
        ...
        return he || (he = 1, (function(n, r) {
            (function(e) {
                function o(f) {
                    ...
                    let a = 1779033703, l = 3144134277, c = 1013904242, h = 2773480762, d = 1359893119, b = 2600822924, _ = 528734635, S = 1541459225;
                    const v = new Uint32Array(64);
                    function I(H) {
                        let Q = 0, k = H.length;
                        for(; k >= 64;){
                            let N = a, W = l, G = c, z = h, T = d, B = b, O = _, q = S, F, R, X, Z, te;
                            ...
                            for(R = 0; R < 64; R++)Z = (((T >>> 6 | T << 26) ^ (T >>> 11 | T << 21) ^ (T >>> 25 | T << 7)) + (T & B ^ ~T & O) | 0) + (q + (s[R] + v[R] | 0) | 0) | 0, te = ((N >>> 2 | N << 30) ^ (N >>> 13 | N << 19) ^ (N >>> 22 | N << 10)) + (N & W ^ N & G ^ W & G) | 0, q = O, O = B, B = T, T = z + Z | 0, z = G, G = W, W = N, N = Z + te | 0;
                            a = a + N | 0, l = l + W | 0, c = c + G | 0, h = h + z | 0, d = d + T | 0, b = b + B | 0, _ = _ + O | 0, S = S + q | 0, Q += 64, k -= 64;
                        }
                    }
                    I(f);
                    let L, D = f.length % 64, P = f.length / 536870912 | 0, M = f.length << 3, J = D < 56 ? 56 : 120, C = f.slice(f.length - D, f.length);
                    for(C.push(128), L = D + 1; L < J; L++)C.push(0);
                    return C.push(P >>> 24 & 255), C.push(P >>> 16 & 255), C.push(P >>> 8 & 255), C.push(P >>> 0 & 255), C.push(M >>> 24 & 255), C.push(M >>> 16 & 255), C.push(M >>> 8 & 255), C.push(M >>> 0 & 255), I(C), [
                        a >>> 24 & 255,
                        a >>> 16 & 255,
                        a >>> 8 & 255,
                        a >>> 0 & 255,
                ...
                function i(f, s, a) {
                    ...
                    for(; a >= 32;)_(), b = b.concat(o(h.concat(o(c)))), a -= 32;
                    return a > 0 && (_(), b = b.concat(o(h.concat(o(c))).slice(0, a))), b;
                }
                ...
                function x(f, s, a, l, c, h, d) {
                    ...
                    let b = i(f, s, c * 128 * l);
                    const _ = new Uint32Array(c * 32 * l);
                    for(let T = 0; T < _.length; T++){
                        const B = T * 4;
                        _[T] = (b[B + 3] & 255) << 24 | (b[B + 2] & 255) << 16 | (b[B + 1] & 255) << 8 | (b[B + 0] & 255) << 0;
                    }
                    const S = new Uint32Array(64 * l), v = new Uint32Array(32 * l * a), I = 32 * l, L = new Uint32Array(16), D = new Uint32Array(16), P = c * a * 2;
                    let M = 0, J = null, C = !1, H = 0, Q = 0, k, N;
                    const W = d ? parseInt(1e3 / l) : 4294967295, G = typeof setImmediate < "u" ? setImmediate : setTimeout, z = function() {
                        if (C) return d(new Error("cancelled"), M / P);
                        let T;
                        switch(H){
                            case 0:
                                N = Q * 32 * l, m(_, N, S, 0, I), H = 1, k = 0;
                            case 1:
                                T = a - k, T > W && (T = W);
                                for(let O = 0; O < T; O++)m(S, 0, v, (k + O) * I, I), p(S, I, l, L, D);
                                if (k += T, M += T, d) {
                                    const O = parseInt(1e3 * M / P);
                                    if (O !== J) {
                                        if (C = d(null, M / P), C) break;
                                        J = O;
                                    }
                                }
                                if (k < a) break;
                            ...
                            case 2:
                                T = a - k, T > W && (T = W);
                                for(let O = 0; O < T; O++){
                                    const q = (2 * l - 1) * 16, F = S[q] & a - 1;
                                    A(v, F * I, S, I), p(S, I, l, L, D);
                                }
                                if (k += T, M += T, d) {
                                    const O = parseInt(1e3 * M / P);
                                    if (O !== J) {
                                ...
                                if (k < a) break;
                                if (m(S, 0, _, N, I), Q++, Q < c) {
                                    H = 0;
                                    break;
                                }
                                b = [];
                                for(let O = 0; O < _.length; O++)b.push(_[O] >> 0 & 255), b.push(_[O] >> 8 & 255), b.push(_[O] >> 16 & 255), b.push(_[O] >> 24 & 255);
                                const B = i(f, b, h);
                    ...
                    scrypt: function(f, s, a, l, c, h, d) {
                        return new Promise(function(b, _) {
                            ...
                            d && d(0), x(f, s, a, l, c, h, function(v, I, L) {
                                if (v) _(v);
                                else if (L) d && S !== 1 && d(1), b(new Uint8Array(L));
    ...
    const se = {
        async decryptDatabase (n, r) {
            ...
            for (const y of e)if (y.type === 1) {
                const x = j(y.salt), E = await ze.scrypt(p, x, y.n, y.r, y.p, 32), f = j(y.key), s = j(y.key_params.nonce), a = j(y.key_params.tag), l = new Uint8Array(f.length + a.length);
            ...
            const u = Fe(t), g = j(o.nonce), A = j(o.tag), m = new Uint8Array(u.length + A.length);
        ...
        async exportToHtml (n) {
            const r = await be(()=>import("./qr-utils-DSii33i3.js").then((t)=>t.b), __vite__mapDeps([0,1,2,3])), e = [];
            e.push(`
      <!DOCTYPE html>
      <html>
      <head>
...
`);
        ...
        async decrypt (n, r) {
            try {
                ...
                if (!e || typeof e != "string") throw new U("无效的 2FAS 加密数据：找不到 servicesEncrypted 字段", "INVALID_2FAS_ENCRYPTED");
                const t = e.split(":");
                if (t.length < 3) throw new U("无效的 2FAS 加密格式：应为 salt:iv:ciphertext", "INVALID_2FAS_FORMAT");
                const i = [
                    t[0],
                    t[1],
                    t.slice(2).join(":")
                ].map((c)=>Uint8Array.from(atob(c.replace(/\s+/g, "")), (h)=>h.charCodeAt(0))), p = (c)=>{
                    const h = c.reduce((_, S)=>_ + S.length, 0), d = new Uint8Array(h);
                    let b = 0;
                    for (const _ of c)d.set(_, b), b += _.length;
                    return d;
                };
                let u, g, A;
                ...
                if (!u || !g || !A) {
                    ...
                    for (const d of h)if (!(!d.salt || !d.iv || !d.cipher) && d.iv.length === K.IV_LEN) try {
                        const b = new TextEncoder().encode(n), _ = await crypto.subtle.importKey("raw", b, {
                            name: "PBKDF2"
                        }, !1, [
                            "deriveKey"
                ...
                if (u.length < 16) throw new U(`salt 长度过短：${u.length}`, "INVALID_SALT_LEN");
                if (g.length !== K.IV_LEN) throw new U("IV 长度错误", "INVALID_IV_LEN");
                ...
                if (A.length < 16) throw new U("密文过短", "CIPHERTEXT_TOO_SHORT");
                ...
                if (!Array.isArray(l)) throw new U("解密后的数据不是数组格式", "INVALID_DECRYPTED_FORMAT");
                return l;
            } catch (e) {
                throw e instanceof U ? e : new U(`2FAS 解密失败：${e.message || String(e)}`, "TWOFAS_DECRYPTION_FAILED", e);
            }
        },
        parsePlain (n) {
        ...
        async decrypt (n, r) {
            try {
                ...
                if (o !== 0) throw new U(`不支持的 KDF 类型: ${o}`, "UNSUPPORTED_BITWARDEN_KDF");
                const i = new TextEncoder().encode(e), p = new TextEncoder().encode(n), u = await crypto.subtle.importKey("raw", p, {
                    ...
                    const c = l[1].split("|"), h = Uint8Array.from(atob(c[0]), (P)=>P.charCodeAt(0)), d = Uint8Array.from(atob(c[1]), (P)=>P.charCodeAt(0)), b = Uint8Array.from(atob(c[2]), (P)=>P.charCodeAt(0)), _ = await crypto.subtle.importKey("raw", a, {
                        name: "HMAC",
                        hash: "SHA-256"
                    }, !1, [
                        "sign"
                    ...
                    const v = new Uint8Array(await crypto.subtle.sign("HMAC", _, S));
                    if (b.length !== v.length) return null;
                    let I = 0;
                    for(let P = 0; P < b.length; P++)I |= b[P] ^ v[P];
                    if (I !== 0) return null;
                ...
                throw new U(`Bitwarden 解密失败: ${e.message}`, "BITWARDEN_DECRYPTION_FAILED", e);
            }
        },
...
`;
        ...
        async parse (n, r) {
            try {
                const e = await _e("openpgp"), t = e?.default || e, o = await t.readMessage({
                    armoredMessage: n
...
`), x = [];
    ...
    async function et() {
        if (re) return re;
        const n = await _e("libsodium"), r = n?.default || n;
    ...
    tt = {
        async parse (n) {
            const r = typeof n == "string" ? Y(n) : n;
            if (!r || !r.shared_secret) throw new U("无效的 Steam maFile: 找不到 shared_secret", "INVALID_MAFILE");
            const t = ((i)=>{
    ...
    rt = {
        async parse (n) {
            try {
                ...
                throw new U("解析 1Password 备份失败: " + (r.message || String(r)), "ONEPASSWORD_PARSE_FAILED", r);
            }
        }
    };
    nt = {
...
`);
    ...
    At = {
        ...
        async fetchAllVault () {
            ...
            if (!n.success) throw new U("无法获取账号数据", "VAULT_FETCH_FAILED");
            return n.vault || [];
        },
        async exportData (n, r, e) {
            ...
            switch(t && Array.isArray(n) && (n = n.filter((o)=>t.includes((o.type || "totp").toLowerCase()))), r){
                ...
                case "nodeauth_csv":
                    return $e.exportToCsv(n);
                default:
                    throw new U("未知的导出类型: " + r, "UNKNOWN_EXPORT_TYPE");
            }
        },
...
export { At as dataMigrationService, __tla };
